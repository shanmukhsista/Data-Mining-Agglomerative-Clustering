...
public class DistanceCalculator implements Runnable {
	public final ListenableUndirectedWeightedGraph<RatingsNode, DefaultWeightedEdge> 	graph;  
	public volatile Double distance ;
	public final RatingsNode currentVertex ; 
	public DistanceCalculator(RatingsNode node , ListenableUndirectedWeightedGraph<RatingsNode, DefaultWeightedEdge> 	graph){
		this.graph =  graph;
	...
	public void run() {
		...
		Set<RatingsNode> vertices = graph.vertexSet();
		...
		for ( RatingsNode vertex : vertices){
